...
* Deploy a NetApp Console agent or link:https://docs.netapp.com/us-en/workload-fsx-ontap/create-link.html[associate a link]. Link connectivity lets Workload Factory analyze all file system configurations like data protection and performance.

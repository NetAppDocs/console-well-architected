...
Link or Console agent connectivity allows Workload Factory to complete a comprehensive scan of your file systems for issues with performance, data protection, and configurations. 
...
. Log in to the link:https://console.netapp.com/home[NetApp Console^].
. From the NetApp Console menu, select *Workloads* and then *Well-architected*.
. From the Well-architected dashboard, *Dismissed configurations*. 

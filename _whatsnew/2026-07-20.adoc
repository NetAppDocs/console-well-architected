...
The well-architected dashboard in the Console is available for link:https://docs.netapp.com/us-en/console-well-architected/cvo/configuration-analysis-cvo.html[Cloud Volumes ONTAP in Microsoft Azure.]

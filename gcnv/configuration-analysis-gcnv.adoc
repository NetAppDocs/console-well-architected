...
* link:https://docs.netapp.com/us-en/console-setup-admin/concept-agent-install-options.html#agent-console-deploy[Deploy a NetApp Console agent^] or link:https://docs.netapp.com/us-en/workload-gcnv/create-link.html[associate a link^]. Console agent and link connectivity let NetApp Console analyze all storage pool configurations like data protection and performance.
...
Workload Factory assesses storage configurations against ONTAP best practices and the Google Cloud Well-Architected Framework. The assessment also recommends improvements and fixes.  

...
= Create a custom rule for FSx for ONTAP in NetApp Console
:hardbreaks:
:nofooter:
:icons: font
:linkattrs:
...
NOTE: If your account admin has turned off AI features, you'll see a message and won't be able to create custom rules. Contact your administrator or link:https://docs.netapp.com/us-en/workload-setup-admin/manage-genai-features.html[learn about AI administration^].
